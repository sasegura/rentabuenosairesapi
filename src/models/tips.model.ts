...
@model({settings: {idInjection: false, postgresql: {schema: 'public', table: 'tips'}}})
export class Tips extends Entity {
  @property({
    ...
    scale: 0,
    id: 1,
    postgresql: {columnName: 'idtips', dataType: 'integer', dataLength: null, dataPrecision: null, dataScale: 0, nullable: 'NO'},
  })
  idtips: number;
